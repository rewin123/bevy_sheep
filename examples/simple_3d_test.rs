...
fn setup(
    ...
    commands.spawn(Camera3dBundle {
        transform : Transform::from_xyz(0.0, 0.0, -100.0).looking_at(Vec3::ZERO, Vec3::Y).with_translation(Vec3::new(0.0, -10.0, -150.0)),
        ..default()
    });
    ...
    commands.spawn(PbrBundle {
        ...
        transform: Transform::from_xyz(0.0, 0.0, 0.0).with_rotation(Quat::from_euler(EulerRot::XYZ, -PI / 4.0, 0.0, 0.0)),
        ..default()
    });
    ...
    let square = meshes.add(shape::Plane { size: 1.0, ..default() }.into());
    ...
    for _ in 0..sheep_count {
        ...
        commands.spawn(PbrBundle {
            ...
            transform: Transform::from_xyz(pos.x, pos.y + 4.0, pos.z).with_rotation(Quat::from_euler(EulerRot::XYZ, -PI / 2.0, PI, 0.0)).with_scale(Vec3::splat(10.0)),
            ..default()
        });
    }
    ...
    for _ in 0..tree_count {
        ...
        commands.spawn(PbrBundle {
            ...
            transform: Transform::from_xyz(pos.x, pos.y + 8.0, pos.z).with_rotation(Quat::from_euler(EulerRot::XYZ, -PI / 2.0, PI, 0.0)).with_scale(Vec3::new(10.0, 10.0, 20.0)),
            ..default()
        });
    }
}